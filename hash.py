...
while next==1:                           #loop to perform various steps  
    ...
    print("5->Send a message and its hash fromm alice")
    print("6->Receive the message and verify using hash by bob")
    ...
    if x==1:                            
        ...
        if flag2==1:                            #to ensure that symmetric key has been shared between bth clients and authentication is complete
            ...
            print("Hash of the message: {}".format(h))
        else:
        ...
        if flag2==2:
            ...
            print("Calculated hash: {}".format(hashFunction(decryptedmessage)))
            if h==hashFunction(decryptedmessage):
                print("Verified")
            else:
